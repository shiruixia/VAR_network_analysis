...
"""Weighted Network Distance implementation copied from the verified Figure 2 code.

Source:
D:\\Desktop\\Task\\course\\复杂网络分析与建模\\final_homework\\article\\paper_assets\\figure2_distance\\src\\utils\\weighted_network_distance.py

Figure 3 uses this module without changing the WD formula. The plotting edge
filter used elsewhere in the paper is intentionally separate from WD input.
"""
